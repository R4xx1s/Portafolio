            ...
            {links.map((link) => (
              <Link
                ...
                className={`text-sm transition-colors ${
                  pathname === link.href
                    ? "text-[rgba(255,255,255,0.92)] font-medium"
                    : "text-[rgba(255,255,255,0.48)] hover:text-[rgba(255,255,255,0.92)]"
                }`}
              >
                {link.label}
              </Link>
            ...
            {links.map((link) => (
              <Link
                ...
                className={`block text-sm transition-colors ${
                  pathname === link.href ? "text-[rgba(255,255,255,0.92)]" : "text-[rgba(255,255,255,0.48)]"
                }`}
              >
                {link.label}
              </Link>
